...
void ui_Screen1_screen_init(void)
{
    ...
    lv_label_set_text(ui_Label29, "200");
    ...
    lv_label_set_text(ui_Label25, "Makerfabs");
    ...
    lv_label_set_text(ui_Label26, "Matouch");
    ...
    lv_label_set_text(ui_Label27, "AMOLED");
    ...
    lv_obj_set_x(ui_Label31, -174);
    lv_obj_set_y(ui_Label31, 155);
    lv_obj_set_align(ui_Label31, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Label31, "Oct        2024");
    lv_obj_set_style_text_color(ui_Label31, lv_color_hex(0xFCFB15), LV_PART_MAIN | LV_STATE_DEFAULT);
